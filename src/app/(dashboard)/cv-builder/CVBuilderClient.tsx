      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-start justify-between mb-5 gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <PDFDownloadButton data={cvData} fileName={`CV_${profile.first_name}_${profile.last_name}_Smartfolio.pdf`} templateKey={tplKey} plan={profile?.plan ?? "free"} profileId={profile?.id ?? ""}/>
          </div>
        </div>
