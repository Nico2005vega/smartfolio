...
export default async function HomePage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "system-ui, sans-serif" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{
            ...
            justifyContent: "center", boxShadow: "0 2px 8px rgba(22,163,74,0.3)",
          }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <Link href="/register" style={{
            ...
            background: "#16a34a", borderRadius: "9px",
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <p style={{
            ...
            margin: "0 0 36px", lineHeight: "1.7", maxWidth: "560px",
            marginLeft: "auto", marginRight: "auto",
          }}>
            Centraliza tus certificados, cursos, diplomados y logros académicos.
            Smartfolio genera tu hoja de vida en segundos.
          </p>
          ...
          <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/register" style={{
              ...
              fontSize: "15px", boxShadow: "0 4px 20px rgba(22,163,74,0.4)",
            }}>
      ...
      <section style={{ padding: "72px 48px", maxWidth: "1100px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <p style={{ fontSize: "16px", color: "#6b7280", margin: 0 }}>
            Diseñado para estudiantes universitarios colombianos
          </p>
        </div>
      ...
      {/* FOOTER */}
      <footer style={{
        background: "#111827", padding: "32px 48px",
        display: "flex", alignItems: "center", justifyContent: "space-between",
