...
export default function AcademicRecordForm({ profileId, record }: Props) {
  ...
  const { register, handleSubmit, watch, formState: { errors } } = useForm<AcademicFormData>({
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-2xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="sm:col-span-2">
          ...
          <input {...register("title")} placeholder="Ej: Certificado en Python Avanzado"
        ...
        <div className="sm:col-span-2">
          ...
          <input {...register("institution")} placeholder="Ej: Platzi, Google, UTS"
            className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500" />
        ...
        <div>
          ...
          <input {...register("duration_hours", { valueAsNumber: true })} type="number" placeholder="60"
            className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500" />
        </div>
        <div>
      ...
      <div>
        ...
        <input {...register("credential_url")} placeholder="https://verify.example.com/abc"
          className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500" />
      ...
      <div>
        ...
        <textarea {...register("description")} rows={3} placeholder="Describe brevemente este logro..."
      ...
      <div>
        ...
        {docId && docName ? (
          ...
          <label className="flex flex-col items-center gap-2 p-6 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-green-400 hover:bg-green-50 transition-colors">
            {uploading ? <Loader2 size={24} className="animate-spin text-green-600" /> : <Upload size={24} className="text-gray-400" />}
      ...
      <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
        <input {...register("is_visible_in_cv")} type="checkbox" id="visible_cv"
